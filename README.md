...
HoopAI is a machine learning project designed to predict NBA game outcomes based on historical team performance data.
Using rolling statistics and feature engineering, HoopAI builds models to forecast both point differentials and win/loss results for NBA matchups.
